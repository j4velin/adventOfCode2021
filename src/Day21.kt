...
private fun part1(input: List<String>): Int {
    ...
    val player1 = Player(input[0].substring("Player 1 starting position: ".length).toInt())
    val player2 = Player(input[1].substring("Player 2 starting position: ".length).toInt())
    while (true) {
