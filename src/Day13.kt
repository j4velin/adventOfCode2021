 ...
 *
 * @param array the page to fold
 * @param foldInstruction folding instruction in the form of 'fold along x=42'
...
private fun fold(array: Array<BooleanArray>, foldInstruction: String): Array<BooleanArray> {
    val split = foldInstruction.removePrefix("fold along ").split("=")
